...
<div class="header high">
    ...
    <h2>
        ...
        Branches: <span class="metric">86.67% <small>(39 / 45)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;
		<span class="missing-if-branch" title="if path not taken" >I</span>if(size === 0 &amp;&amp; !that.readable) {
<span class="cstat-no" title="statement not covered" >			that.emit("end");</span>
...
&nbsp;
	this.destroy = function() {
		that.emit("end");
		<span class="missing-if-branch" title="else path not taken" >E</span>if(sendData.interval) clearTimeout(sendData.interval);
		sendData = null;
		that.readable = false;
		that.emit("close");
	};
&nbsp;
	this.destroySoon = function() {
		that.readable = false;
		<span class="missing-if-branch" title="else path not taken" >E</span>if (!sendData.interval) {
			that.emit("end");
			that.emit("close");
		}
	};
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Wed Oct 22 2014 22:13:57 GMT+1100 (AEDT)</div>
</div>
